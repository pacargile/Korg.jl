...
# returns the Wishart (1979) cross-sections in units of cm²
const _Hminus_bf_cross_section_interp_Wishart = let
    WBF = [18.000, 19.600, 21.400, 23.600, 26.400, 29.800, 34.300, 
           40.400, 49.100, 62.600, 111.300, 112.100, 112.670, 
           112.950, 113.050, 113.100, 113.200, 113.230, 113.500, 
           114.400, 121.000, 139.000, 164.000, 175.000, 200.000, 
           225.000, 250.000, 275.000, 300.000, 325.000, 350.000, 
           375.000, 400.000, 425.000, 450.000, 475.000, 500.000, 
           525.000, 550.000, 575.000, 600.000, 625.000, 650.000, 
           675.000, 700.000, 725.000, 750.000, 775.000, 800.000, 
           825.000, 850.000, 875.000, 900.000, 925.000, 950.000, 
           975.000, 1000.000, 1025.000, 1050.000, 1075.000, 
           1100.000, 1125.000, 1150.000, 1175.000, 1200.000, 
           1225.000, 1250.000, 1275.000, 1300.000, 1325.000, 
           1350.000, 1375.000, 1400.000, 1425.000, 1450.000, 
           1475.000, 1500.000, 1525.000, 1550.000, 1575.000, 
           1600.000, 1610.000, 1620.000, 1630.000, 1643.910]

    BF = [0.0670, 0.0880, 0.1170, 0.1550, 0.2060, 0.2830, 0.4140, 
          0.7030, 1.240, 2.330, 11.600, 13.900, 24.300, 66.700, 
          95.000, 56.600, 20.000, 14.600, 8.500, 7.100, 5.430, 
          5.910, 7.290, 7.9180, 9.4530, 11.080, 12.750, 14.460, 
          16.190, 17.920, 19.650, 21.350, 23.020, 24.650, 26.240, 
          27.770, 29.230, 30.620, 31.940, 33.170, 34.320, 35.370, 
          36.320, 37.170, 37.910, 38.540, 39.070, 39.480, 39.770, 
          39.950, 40.010, 39.950, 39.770, 39.480, 39.060, 38.530, 
          37.890, 37.130, 36.250, 35.280, 34.190, 33.010, 31.720, 
          30.340, 28.870, 27.330, 25.710, 24.020, 22.260, 20.460, 
          18.620, 16.740, 14.850, 12.950, 11.070, 9.2110, 7.4070, 
          5.6770, 4.0520, 2.5750, 1.3020, 0.86970, 0.49740, 
          0.19890, 0.00]
    ν_wishart = 1e7 ./ WBF .* c_cgs  # nm → cm → Hz
    σ_wishart = BF .* 1e-18               # to cm²
    linear_interpolation(reverse(ν_wishart), reverse(σ_wishart); extrapolation_bc=Throw())
end    
function _Hminus_bf_cross_section_wishart(ν)
    _H⁻_ion_ν = _H⁻_ion_energy / hplanck_eV
    if ν <= _H⁻_ion_ν
        0.0
    else
        _Hminus_bf_cross_section_interp_Wishart(ν)
    end
end

# compute the H⁻ bf absorption coefficient in units of cm⁻¹.
